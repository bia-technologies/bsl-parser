...
Процедура ТестСоздатьПростоеРасширениеВИерархическомФорматеКонфигуратора() Экспорт
	...
	Генератор = ГенераторBSL.ГенераторРасширения(КаталогРасширения, ФорматыВыгрузки.Конфигуратор_8_3_10);
	Генератор.УстановитьОписание("Simple", "Простое расширение", "smpl_");
...
Процедура ТестСоздатьПростоеРасширениеВФорматеEDT() Экспорт
	...
	Генератор = ГенераторBSL.ГенераторРасширения(КаталогРасширения, ФорматыВыгрузки.EDT);
	Парсер = ПарсерBSL.ПарсерКонфигурации(КаталогКонфигурации);
