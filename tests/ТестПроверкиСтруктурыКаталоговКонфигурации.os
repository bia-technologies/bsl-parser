...
Процедура ТестСтруктураКаталоговВыгрузкаКонфигуратора() Экспорт
	...
	СтруктураКаталоговКонфигурации = Новый СтруктураКаталоговКонфигурации(КаталогКонфигурации, "Designer2.4");
	...
	Утверждения.ПроверитьРавенство(СтруктураКаталоговКонфигурации.ИмяФайлаОписанияОбъекта("Пользователи", "Catalog"), Эталон, "Не корректное имя файла опсания объекта");
...
Процедура ТестСтруктураКаталоговВыгрузкаEDT() Экспорт
	...
	КаталогКонфигурации = "configuration";
	СтруктураКаталоговКонфигурации = Новый СтруктураКаталоговКонфигурации(КаталогКонфигурации, "EDT");
